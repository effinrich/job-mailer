# Pipeline — the dashboard

One row per contact. This is the home screen: glance here, know everything.
`Next` is the single next action. `Due` is when it's needed (for follow-ups).
...
| Cortex (campaign) | Cortex | Sr Product Design Engineer (IDP) | `sent` | ✅ Applied + cold email SENT to anish@cortex.io. Watch for reply; follow-up day 5–7 if silent | — |
| Infisical (campaign) | Infisical | Design Engineer, Platform (OSS security) | `researching` | Apply via Ashby + cover letter + Loom; cold email to vlad@infisical.com (CEO, ex-Figma) DRAFTED → Send after applying; PR=skip | — |
...
move its row to the Archive below to keep the active board short.
-->

## Archive (closed)

| Contact | Company | Outcome | Closed |
|---------|---------|---------|--------|
| — | — | — | — |
